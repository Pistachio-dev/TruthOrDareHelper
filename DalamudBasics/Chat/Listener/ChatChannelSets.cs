...
namespace DalamudBasics.Chat.Listener
{
    public static class ChatChannelSets
    {
        ...
        public static XivChatType[] CommonChannelsAndLinkshells = [XivChatType.Say, XivChatType.Shout, XivChatType.Yell, XivChatType.Party, XivChatType.Alliance,
            XivChatType.CrossLinkShell1, XivChatType.CrossLinkShell2, XivChatType.CrossLinkShell3, XivChatType.CrossLinkShell4, XivChatType.CrossLinkShell5,
